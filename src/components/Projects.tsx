...
const Projects: React.FC = () => {
  ...
  const filteredProjects =
    selectedCategory === 'All'
      ...
      : projects.filter(
          project => !project.featured && project.category === selectedCategory
        );
    ...
    >
      <div className='mx-auto max-w-7xl'>
        ...
        >
          {featuredProjects.length > 0 ? (
            <>
              <div className='perspective-1000 overflow-hidden rounded-2xl shadow-2xl sm:rounded-3xl'>
              ...
              {featuredProjects.length > 1 && (
                <>
                  <motion.button
                    onClick={prevProject}
                    className='absolute left-6 top-1/2 -translate-y-1/2 transform rounded-full bg-slate-800/90 p-4 text-white shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-slate-700 hover:shadow-xl'
                    whileHover={{
                      scale: 1.1,
                      x: -5,
                      boxShadow: '0 10px 25px rgba(0,0,0,0.3)',
                  ...
                  <motion.button
                    onClick={nextProject}
                    className='absolute right-6 top-1/2 -translate-y-1/2 transform rounded-full bg-slate-800/90 p-4 text-white shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-slate-700 hover:shadow-xl'
                    whileHover={{
                      scale: 1.1,
                      x: 5,
                      boxShadow: '0 10px 25px rgba(0,0,0,0.3)',
